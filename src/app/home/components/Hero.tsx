...
export default function Hero() {
  ...
  return (
    <>
      <img src='images/Group 30.svg' alt="group1" className="absolute md:left-[10%] top-[30%] md:bottom-[30%] max-md:w-11" />
      <img src='/images/Group 31.svg' alt="group2" className="absolute right-[10%] top-[15%] max-md:w-11" />
      <div className="text-center xl:w-[55%] m-auto md:w-[70%] max-md:mt-24 w-[85%] ">
        ...
        <p className="text-gray-400 mt-9 mb-7  md:px-[10%] max-md:text-sm">Intelligent business built right into the heart you add sales and expenses you view profit and revenue generated daily, monthly per annum</p>
