export default function Hero() {
  ...
  return (
    <>
      ...
      {/* <img src="/images/Group 1000002780.png" alt="finance" className="" />
      <img src="/images/finance-calculation-3d.png" alt="finance" className=""/> */}
      <div className="text-center xl:w-[40%] m-auto lg:w-[70%] max-md:mt-24 w-[85%]">
       ...
       Automate
        ...
        <div className="flex justify-center md:gap-5 gap-3 font-semibold">
          <button className="text-white  md:px-[30px] px-5 md:py-[18px] py-2 rounded-[10px] bg-[#329ACF] ease-in-out max-md:text-xs hover:bg-bime-blue">Start free trial</button>
