...
export default function GoodBye() {
  ...
  return (
    <>
      <div className="footer-bg w-full items-center md:py-36 py-16 mt-28 text-center">
      ...
      <footer className="md:w-full w-[90%] mx-auto md:px-24 md:py-20 py-10 md:-mt-11 mt-24 flex justify-between">
