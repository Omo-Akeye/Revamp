...
export default function Nav() {
  return (
    <nav className="flex justify-between md:mt-[52px] mt-9 w-[90%] mx-auto">
        ...
        <ul className="flex items-center text-sm font-semibold text-gray-400 gap-7 max-lg:hidden">
            ...
            <li className="flex gap-3 font-bold">
                <Link href='/login' className="text-bime-blue border-[0.3px] border-bime-blue px-8 py-[10px] rounded-[10px]">
                Log in
                </Link>
                <Link href='/'  className="px-10 py-[10px] text-white rounded-[10px] bg-bime-blue hover:bg-[#329ACF]">
                Get started
                </Link>
            </li>
        </ul>
