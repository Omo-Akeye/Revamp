...
export default function Why() {
  return (
    <div className='md:mt-16 mt-14'>
        ...
        <div className='flex gap-x-10 w-[85%] mx-auto max-lg:gap-y-8 justify-center max-lg:flex-col max-lg:items-center'>
            ...
            <p className='md:text-lg  text-sm max-md:mt-[6px] '>As your business starts to grow you need a system that can help in accelerating its growth</p>
            </div>
            ...
            <h1 className='md:text-[32px] text-2xl font-semibold mb-5'>Without Bime</h1>
                <ul className="md:text-lg md:gap-y-3 gap-4 list-inside list-disc">
  ...
  <li className="md:text-lg list-inside list-disc">
