...
export default function Why() {
  return (
    <div className='md:mt-10 mt-14'>
        ...
        <div className='flex gap-x-10 w-[90%] mx-auto max-lg:gap-y-8 justify-center max-lg:flex-col max-lg:items-center'>
            ...
            <p className='max-md:mt-[6px] max-sm:text-xs'>As your business starts to grow you need a system that can help in accelerating its growth</p>
            </div>
            ...
            <h1 className='md:text-[32px] text-2xl font-semibold mb-5'>Without Bime</h1>
                <ul className="md:gap-y-3 gap-4 list-inside list-disc max-sm:text-xs">
  ...
  <li className=" list-inside list-disc max-sm:text-xs">
