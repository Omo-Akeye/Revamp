...
export default function Hero() {
  ...
  return (
    <>
      <img src='images/Group 30.svg' alt="group1" className="absolute lg:left-[10%] left-[2%] md:left-[5%] md:top-[50%] top-[28%] max-md:w-11" />
      <img src='/images/Group 31.svg' alt="group2" className="absolute right-[15%] md:top-[15%] top-[12%] max-md:w-11" />
      <img src="/images/Group 1000002780.png" alt="finance" className="absolute w-[73px] h-[73px] md:right-[15%] right-[3%] md:bottom-[35%] max-md:top-[28%] max-md:w-11 max-md:h-11" />
